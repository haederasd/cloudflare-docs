...
If you experience website issues, we recommend [temporarily pausing Cloudflare](/fundamentals/manage-domains/pause-cloudflare/) to evaluate your website's performance.
...
2. On the **Overview** page, find **Advanced Actions** and then select **Remove Site from Cloudflare**.
   ...
   :::note
   If you are using an Enterprise domain, [change your domain plan](/billing/change-plan/#change-plan-type) to **Free**, which will give you access to **Remove Site from Cloudflare**.<br/><br/>If this does not work, contact your Customer Success Manager.
   :::
