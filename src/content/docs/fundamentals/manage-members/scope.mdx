...
1. In the Cloudflare dashboard, go to **Settings** > **Lists**. (You must be logged in as a **Super Administrator** and have a [verified email address](/fundamentals/user-profiles/verify-email-address/)).
