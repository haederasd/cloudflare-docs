...
* You must have a [verified account email address](/fundamentals/user-profiles/verify-email-address/), to transfer or register domains.
...
1. In the Cloudflare dashboard, go to **Register domains**.
