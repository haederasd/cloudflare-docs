...
// From github-slugger:
// - https://github.com/Flet/github-slugger/blob/master/regex.js
const regex =
...
function slug(path: string, maintainCase: boolean = false) {
	if (typeof path !== "string") return "";
	if (!maintainCase) path = path.toLowerCase();

	return path.replace(regex, "").replace(/ /g, "-");
}
	...
	try {
		...
		const changedFiles = files
			...
			.map((file) => {
				...
				core.debug(filePathToUriPath(file.file.filename));
